 ...
 * `opencode`, `pi`, and `hermes` have no proxy handler; their usage reaches
 * this dashboard through session importers. `openclaw` appears only as a
 * managed app elsewhere.
 */
export type AppType =
  | "claude"
  | "codex"
